...
async function initializeFeatureModules() {
  const modules = [
    ...
    // Modules optionnels
    { code: 'logistique', name: 'Logistique', description: 'Tâches magasiniers et suivi', category: 'organisation', icon: 'ArchiveBoxIcon', isActive: true, isSystem: false, ordre: 9 },
