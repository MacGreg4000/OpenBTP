...
23/09/2026). **Les textes ci-dessous doivent être relus par le conseil juridique
de Secotech avant activation.**
...
**Nouvel art. 8.8 — Pénalité forfaitaire** *(écrire le montant directement dans le template)* :
